def load():
    return {
        ...
        'lines': [
            ...
            ['L7-8-1',  'B7',       'B8',       110/2,        100,    230,    'p.u.',     1e-4,   1e-3,   1.75e-3],
            ['L7-8-2',  'B7',       'B8',       110/2,        100,    230,    'p.u.',     1e-4,   1e-3,   1.75e-3],
            ['L8-9-1',  'B8',       'B9',       110/2,        100,    230,    'p.u.',     1e-4,   1e-3,   1.75e-3],
            ['L8-9-2',  'B8',       'B9',       110/2,        100,    230,    'p.u.',     1e-4,   1e-3,   1.75e-3],
        ...
        'generators': {
            'GEN': [
                ...
                #['G1',      'B1',   900,    20,     500,    1.03,   6.5,    0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
                ['G2',      'B2',   900,    20,     500,    1.01,   6.5,    0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
                ['G3',      'B3',   900,    20,     569,    1.03,   6.175,  0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
                ['G4',      'B4',   900,    20,     500,    1.01,   6.175,  0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
                ['SC',      'B1',   215,    20,     0,    1.01,   1.6,  0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
            ]
        },
        ...
        'gov': {
            ...
            'HYGOV': [
                ...
                ['HYGOV3', 'G3', 0.06, 0.5, 0.05, 5, 0.2, 1, 1, 0.01, 0.01, 0.0, 100, 2, 0],
                ['HYGOV4', 'G4', 0.06, 0.5, 0.05, 5, 0.2, 1, 1, 0.01, 0.01, 0.0, 100, 2, 0],
            ],
        },
        ...
        'pss': {
            'STAB1': [
               ...
               ['PSS5',    'SC',   50,     10.0,   0.5,    0.5,    0.05,   0.05,   0.03],
            ]
        },
    }