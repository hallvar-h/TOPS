# Kundor two-area system with HYGOV and AGC
...
def load():
    return {
        ...
        'ace0': {
            ...
            'AGC1': [
                ['name',  'gen',     'line',       'lambda',    'K_p', 'K_i',  'alpha'],
                ['ACE1',   'G1',       'L7-8-1',   200*50/900,   0.0,  0.01,     0.25],
                ['ACE2',   'G2',       'L7-8-1',   200*50/900,   0.0,  0.01,     0.25],
                ['ACE3',   'G3',       'L7-8-1',   200*50/900,   0.0,  0.01,     0.25],
                ['ACE4',   'G4',       'L7-8-1',   200*50/900,   0.0,  0.01,     0.25],
            ]
