...
def load():
    return {
        ...
        'generators': [
            ...
            ['G10',     '30',      1000,   16.5,    0.85,   250.,   1.0475,  1,       4.2,      0,      1.,     0.69,       0.31,       0.5,        0.25,       0.25,       10.2,       0.5,        0.05,       0.035],  # In the PowerFactory-model, this generator is originally salient pole, and T_q0_t = 0.
        ],
