...
def load():
    return {
        ...
        'generators': [
            ['name',    'bus',     'S_n',  'V_n',   'P',    'V',     'N_par', 'H',     'D',     'X_d',  'X_q',      'X_d_t',    'X_q_t',    'X_d_st',   'X_q_st',   'T_d0_t',   'T_q0_t',   'T_d0_st',  'T_q0_st'],
            ['G1',      '39',      10000,  345.,    1000.,  1.03,    1,       5.,       0,      2.,     1.9,        0.6,        0.8,        0.4,        0.4,        7.,         0.7,        0.05,       0.035],
            ['G2',      '31',      700,    16.5,    0.,     0.982,   1,       4.329,    0,      2.065,  1.974,      0.4879,     1.19,       0.35,       0.35,       6.56,       1.5,        0.05,       0.035],
            ['G3',      '32',      800,    16.5,    650.,   0.9831,  1,       4.475,    0,      1.996,  1.896,      0.4248,     0.7008,     0.36,       0.36,       5.7,        1.5,        0.05,       0.035],
            ['G4',      '33',      800,    16.5,    632.,   0.9972,  1,       3.575,    0,      2.096,  2.064,      0.3488,     1.328,      0.28,       0.28,       5.69,       1.5,        0.05,       0.035],
            ['G5',      '34',      300,    16.5,    254.,   1.0123,  2,       4.333,    0,      2.01,   1.86,       0.396,      0.498,      0.267,      0.267,      5.4,        0.44,       0.05,       0.035],
            ['G6',      '35',      800,    16.5,    650.,   1.0493,  1,       4.35,     0,      2.032,  1.928,      0.4,        0.6512,     0.32,       0.32,       7.3,        0.4,        0.05,       0.035],
            ['G7',      '36',      700,    16.5,    560.,   1.0635,  1,       3.771,    0,      2.065,  2.044,      0.343,      1.302,      0.308,      0.308,      5.66,       1.5,        0.05,       0.035],
            ['G8',      '37',      700,    16.5,    540.,   1.0278,  1,       3.471,    0,      2.03,   1.96,       0.399,      0.6377,     0.315,      0.315,      6.7,        0.41,       0.05,       0.035],
            ['G9',      '38',      1000,   16.5,    830.,   1.0265,  1,       3.45,     0,      2.106,  2.05,       0.57,       0.587,      0.45,       0.45,       4.79,       1.96,       0.05,       0.035],
            ['G10',     '30',      1000,   16.5,    250.,   1.0475,  1,       4.2,      0,      1.,     0.69,       0.31,       0.5,        0.25,       0.25,       10.2,       0.5,        0.05,       0.035],  # In the PowerFactory-model, this generator is originally salient pole, and T_q0_t = 0.
        ],
